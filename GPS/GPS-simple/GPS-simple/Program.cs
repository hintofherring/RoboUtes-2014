...
namespace GPS_simple
{
    class Program
    {
        ...
        static void gps_PositionFixStatusChange(object sender, GPSPositionFixStatusChangeEventArgs e)
        {
            Console.WriteLine("PositionFixStatusChanged");
            Console.WriteLine("\tnew position fix status: " + gps.PositionFixStatus);
        }
