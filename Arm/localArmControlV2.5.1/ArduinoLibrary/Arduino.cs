        ...
        private void checkConnection() {
            while (true) {
                ...
                lock (sync) {
                    ...
                    {
                        throw new ArduinoCOMCloseError("check failed! ARDUINO DISCONNECTED!"); //TODO: Maybe make this an event, not an exception. That way it wouldnt stop all excecution
                    }
                    else if (!recentData) {
                        lock (ArduinoSerial)
                        {
